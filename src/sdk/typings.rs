...
// 激活的区域
// ENUM!{enum AcActiveSpace {
//     acPaperSpace = 0,
//     acModelSpace = 1,
// }}

// 键盘的一些访问区域
// ENUM!{enum AcKeyboardAccelerator {
//     acPreferenceClassic = 0,
//     acPreferenceCustom = 1,
// }}
// 
// ENUM!{enum AcPlotOrientation {
...
// ENUM!{enum AcHorizontalAlignment {
...
// ENUM!{enum AcTextGenerationFlag {
...
// ENUM!{enum AcHatchStyle {
//     acHatchStyleNormal = 0,
//     acHatchStyleOuter = 1,
//     acHatchStyleIgnore = 2,
// }}

// ENUM!{enum AcPolylineType {
//     acSimplePoly = 0,
//     acFitCurvePoly = 1,
//     acQuadSplinePoly = 2,
//     acCubicSplinePoly = 3,
...
// ENUM!{enum Ac3DPolylineType {
//     acSimple3DPoly = 0,
//     acQuadSpline3DPoly = 1,
//     acCubicSpline3DPoly = 2,
// }}

// ENUM!{enum AcViewportSplitType {
...
// ENUM!{enum AcRegenType {
//     acActiveViewport = 0,
//     acAllViewports = 1,
// }}

// ENUM!{enum AcBooleanType {
//     acUnion = 0,
//     acIntersection = 1,
//     acSubtraction = 2,
// }}

// ENUM!{enum AcExtendOption {
//     acExtendNone = 0,
...
// ENUM!{enum AcMeasurementUnits {
//     acEnglish = 0,
//     acMetric = 1,
// }}

// ENUM!{enum AcXRefDemandLoad {
//     acDemandLoadDisabled = 0,
//     acDemandLoadEnabled = 1,
//     acDemandLoadEnabledWithCopy = 2,
// }}

// ENUM!{enum AcPreviewMode {
//     acPartialPreview = 0,
//     acFullPreview = 1,
// }}

// ENUM!{enum AcPolymeshType {
//     acSimpleMesh = 0,
//     acQuadSurfaceMesh = 5,
...
// ENUM!{enum AcProxyImage {
//     acProxyNotShow = 0,
//     acProxyShow = 1,
//     acProxyBoundingBox = 2,
// }}

// ENUM!{enum AcKeyboardPriority {
//     acKeyboardRunningObjSnap = 0,
//     acKeyboardEntry = 1,
//     acKeyboardEntryExceptScripts = 2,
// }}

// ENUM!{enum AcMenuGroupType {
//     acBaseMenuGroup = 0,
//     acPartialMenuGroup = 1,
// }}

// ENUM!{enum AcMenuFileType {
//     acMenuFileCompiled = 0,
//     acMenuFileSource = 1,
// }}

// ENUM!{enum AcMenuItemType {
//     acMenuItem = 0,
//     acMenuSeparator = 1,
//     acMenuSubMenu = 2,
// }}

// ENUM!{enum AcToolbarItemType {
//     acToolbarButton = 0,
...
// ENUM!{enum AcWindowState {
//     acNorm = 1,
//     acMin = 2,
//     acMax = 3,
// }}

// ENUM!{enum AcPlotPaperUnits {
//     acInches = 0,
//     acMillimeters = 1,
//     acPixels = 2,
// }}

// ENUM!{enum AcPlotRotation {
//     ac0degrees = 0,
//     ac90degrees = 1,
//     ac180degrees = 2,
//     ac270degrees = 3,
...
// pub type ACAD_COLOR = AcColor;

// pub type ACAD_LAYER = BSTR;

// pub type ACAD_LTYPE = BSTR;

// pub type ACAD_NULL = i32;

// pub type ACAD_DISTANCE = f64;

// pub type ACAD_ANGLE = f64;

// pub type ACAD_LWEIGHT = AcLineWeight;

// pub type ACAD_NOUNITS = f64;

// pub type ACAD_POINT = VARIANT;

// ENUM!{enum AcLineSpacingStyle {
//     acLineSpacingStyleAtLeast = 1,
//     acLineSpacingStyleExactly = 2,
// }}

// ENUM!{enum AcDimPrecision {
...
// ENUM!{enum AcDimFractionType {
//     acHorizontal = 0,
//     acDiagonal = 1,
//     acNotStacked = 2,
// }}

// ENUM!{enum AcDimArcLengthSymbol {
//     acSymInFront = 0,
//     acSymAbove = 1,
//     acSymNone = 2,
// }}

// ENUM!{enum AcDimHorizontalJustification {
//     acHorzCentered = 0,
...
// ENUM!{enum AcDimVerticalJustification {
//     acVertCentered = 0,
//     acAbove = 1,
//     acOutside = 2,
//     acJIS = 3,
...
// ENUM!{enum AcDimTextMovement {
//     acDimLineWithText = 0,
//     acMoveTextAddLeader = 1,
//     acMoveTextNoLeader = 2,
// }}

// ENUM!{enum AcDimToleranceMethod {
//     acTolNone = 0,
//     acTolSymmetrical = 1,
//     acTolDeviation = 2,
//     acTolLimits = 3,
...
// ENUM!{enum AcDimToleranceJustify {
//     acTolBottom = 0,
//     acTolMiddle = 1,
//     acTolTop = 2,
// }}

// ENUM!{enum AcViewportScale {
//     acVpScaleToFit = 0,
//     acVpCustomScale = 1,
//     acVp1_1 = 2,
//     acVp1_2 = 3,
...
// ENUM!{enum AcPlotPolicyForNewDwgs {
//     acPolicyNewDefault = 0,
//     acPolicyNewLegacy = 1,
// }}

// ENUM!{enum AcPlotPolicyForLegacyDwgs {
//     acPolicyLegacyDefault = 0,
//     acPolicyLegacyQuery = 1,
//     acPolicyLegacyLegacy = 2,
// }}

// ENUM!{enum AcOleQuality {
//     acOQLineArt = 0,
//     acOQText = 1,
//     acOQGraphics = 2,
//     acOQPhoto = 3,
...
// ENUM!{enum AcLoadPalette {
//     acPaletteByDrawing = 0,
//     acPaletteBySession = 1,
// }}

// ENUM!{enum AcInsertUnits {
...
// ENUM!{enum AcAlignmentPointAcquisition {
//     acAlignPntAcquisitionAutomatic = 0,
//     acAlignPntAcquisitionShiftToAcquire = 1,
// }}

// ENUM!{enum AcInsertUnitsAction {
//     acInsertUnitsPrompt = 0,
//     acInsertUnitsAutoAssign = 1,
// }}

// ENUM!{enum AcPlotPolicy {
//     acPolicyNamed = 0,
//     acPolicyLegacy = 1,
// }}

// ENUM!{enum AcDrawingAreaShortCutMenu {
//     acNoDrawingAreaShortCutMenu = 0,
//     acUseDefaultDrawingAreaShortCutMenu = 1,
// }}

// ENUM!{enum AcDrawingAreaSCMDefault {
//     acRepeatLastCommand = 0,
//     acSCM = 1,
// }}

// ENUM!{enum AcDrawingAreaSCMEdit {
//     acEdRepeatLastCommand = 0,
//     acEdSCM = 1,
// }}

// ENUM!{enum AcDrawingAreaSCMCommand {
//     acEnter = 0,
//     acEnableSCMOptions = 1,
//     acEnableSCM = 2,
// }}

// ENUM!{enum AcLayerStateMask {
//     acLsNone = 0,
//     acLsOn = 1,
//     acLsFrozen = 2,
//     acLsLocked = 4,
...
// ENUM!{enum AcHatchObjectType {
//     acHatchObject = 0,
//     acGradientObject = 1,
// }}

// ENUM!{enum AcGradientPatternType {
//     acPreDefinedGradient = 0,
//     acUserDefinedGradient = 1,
// }}

// ENUM!{enum AcTableDirection {
//     acTableTopToBottom = 0,
//     acTableBottomToTop = 1,
// }}

// ENUM!{enum AcCellAlignment {
//     acTopLeft = 1,
//     acTopCenter = 2,
//     acTopRight = 3,
//     acMiddleLeft = 4,
...
// ENUM!{enum AcParseOption {
//     acParseOptionNone = 0,
//     acSetDefaultFormat = 1,
//     acPreserveMtextFormat = 2,
// }}

// ENUM!{enum AcFormatOption {
//     kFormatOptionNone = 0,
//     acForEditing = 1,
//     acForExpression = 2,
...
// ENUM!{enum AcCellType {
//     acUnknownCell = 0,
//     acTextCell = 1,
//     acBlockCell = 2,
// }}

// ENUM!{enum AcCellEdgeMask {
//     acTopMask = 1,
//     acRightMask = 2,
//     acBottomMask = 4,
//     acLeftMask = 8,
...
// ENUM!{enum AcMergeCellStyleOption {
...
// ENUM!{enum AcOlePlotQuality {
//     acOPQMonochrome = 0,
//     acOPQLowGraphics = 1,
//     acOPQHighGraphics = 2,
// }}

// ENUM!{enum AcTableStyleOverrides {
//     acTitleSuppressed = 1,
...
// ENUM!{enum AcMLineJustification {
//     acTop = 0,
//     acZero = 1,
//     acBottom = 2,
// }}

// ENUM!{enum AcBlockScaling {
//     acAny = 0,
//     acUniform = 1,
// }}

// ENUM!{enum AcDynamicBlockReferencePropertyUnitsType {
//     acNoUnits = 0,
//     acAngular = 1,
//     acDistance = 2,
//     acArea = 3,
...
// ENUM!{enum AcHelixConstrainType {
//     acTurnHeight = 0,
//     acTurns = 1,
//     acHeight = 2,
// }}

// ENUM!{enum AcShadowDisplayType {
...
// ENUM!{enum AcLoftedSurfaceNormalType {
//     acRuled = 0,
//     acSmooth = 1,
//     acFirstNormal = 2,
//     acLastNormal = 3,
...
// ENUM!{enum AcHelixTwistType {
//     acCCW = 0,
//     acCW = 1,
// }}

// ENUM!{enum AcUnderlayLayerOverrideType {
//     acNoOverrides = 0,
//     acApplied = 1,
// }}

// ENUM!{enum AcTableFlowDirection {
//     acTableFlowRight = 1,
//     acTableFlowDownOrUp = 2,
//     acTableFlowLeft = 4,
// }}

// ENUM!{enum AcCellMargin {
//     acCellMarginTop = 1,
//     acCellMarginLeft = 2,
...
// ENUM!{enum AcCellOption {
//     kCellOptionNone = 0,
//     kInheritCellFormat = 1,
// }}

// ENUM!{enum AcTextAttachmentType {
...
// ENUM!{enum AcMLeaderType {
//     acStraightLeader = 1,
//     acSplineLeader = 2,
//     acInVisibleLeader = 0,
// }}

// ENUM!{enum AcMLeaderContentType {
//     acNoneContent = 0,
//     acBlockContent = 1,
//     acMTextContent = 2,
// }}

// ENUM!{enum AcTextAlignmentType {
//     acLeftAlignment = 0,
//     acCenterAlignment = 1,
//     acRightAlignment = 2,
// }}

// ENUM!{enum AcTextAngleType {
//     acInsertAngle = 0,
//     acHorizontalAngle = 1,
//     acAlwaysRightReadingAngle = 2,
// }}

// ENUM!{enum AcBlockConnectionType {
//     acConnectExtents = 0,
//     acConnectBase = 1,
// }}

// ENUM!{enum AcPredefBlockType {
//     acBlockImperial = 0,
//     acBlockSlot = 1,
//     acBlockCircle = 2,
//     acBlockBox = 3,
...
// ENUM!{enum AcDrawLeaderOrderType {
//     acDrawLeaderHeadFirst = 0,
//     acDrawLeaderTailFirst = 1,
// }}

// ENUM!{enum AcDrawMLeaderOrderType {
//     acDrawContentFirst = 0,
//     acDrawLeaderFirst = 1,
// }}

// ENUM!{enum AcSegmentAngleType {
//     acDegreesAny = 0,
//     acDegrees15 = 1,
//     acDegrees30 = 2,
//     acDegrees45 = 3,
...
// ENUM!{enum AcTextAttachmentDirection {
//     acAttachmentHorizontal = 0,
//     acAttachmentVertical = 1,
// }}

// ENUM!{enum AcVerticalTextAttachmentType {
//     acAttachmentCenter = 0,
//     acAttachmentLinedCenter = 1,
// }}

// ENUM!{enum AcMeshCreaseType {
//     acNoneCrease = 0,
//     acAlwaysCrease = 1,
//     acCreaseByLevel = 2,
// }}